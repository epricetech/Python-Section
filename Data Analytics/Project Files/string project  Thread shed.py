# -*- coding: utf-8 -*-
"""
Created on Thu Feb  9 09:29:47 2023
...
transactions_clean = []
#go throughs the groups in the list
for i in daily_transactions_split:
  # the second for loop goes through each data point in the group in the list - a next layer deeper into the list
    transactions_clean = []
    for data in i:
...
total_sales = 0
# doesnt run because of this statement
for sale in sales:
...
colors = ['red', 'yellow', 'green', 'white', 'black', 'blue', 'pruple']
